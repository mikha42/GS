...
public class Creature : MonoBehaviour {
    ...
    public void Look()
    {
        ...
        RaycastHit2D viewForward = Physics2D.Raycast(
            ...
            new Vector2(Mathf.Cos(transform.rotation.z) * 0.5f, Mathf.Sin(transform.rotation.z) * 0.5f), //Add direction vector, to avoid touching the collider of the sprite.
            new Vector2(Mathf.Cos(transform.rotation.z), Mathf.Sin(transform.rotation.z)), //Direction of raycast in a vector (normalized direction in this case)
            5 //Maximum distance
            );
        RaycastHit2D viewLeft1 = Physics2D.Raycast(
            new Vector2(transform.position.x, transform.position.y) + //Position of raycast
            new Vector2(Mathf.Cos(transform.rotation.z + 10) * 0.5f, Mathf.Sin(transform.rotation.z + 10) * 0.5f), //Add direction vector, to avoid touching the collider of the sprite.
            new Vector2(Mathf.Cos(transform.rotation.z + 10), Mathf.Sin(transform.rotation.z + 10)), //Direction of raycast in a vector (normalized direction in this case)
            4 //Maximum distance
        );
        RaycastHit2D viewLeft2 = Physics2D.Raycast(
            new Vector2(transform.position.x, transform.position.y) + //Position of raycast
            new Vector2(Mathf.Cos(transform.rotation.z + 20) * 0.5f, Mathf.Sin(transform.rotation.z + 20) * 0.5f), //Add direction vector, to avoid touching the collider of the sprite.
            new Vector2(Mathf.Cos(transform.rotation.z + 20), Mathf.Sin(transform.rotation.z + 20)), //Direction of raycast in a vector (normalized direction in this case)
            3 //Maximum distance
        );
        ...
        Debug.DrawRay(new Vector2(transform.position.x, transform.position.y) + anglevector, anglevector);
