...
public class CameraMovement : MonoBehaviour {
    ...
    void Start () {
        ...
        //Used for geting change in mouse movement
	...
	void Update () {
        ...
        mouseBefore = mouseNow; //Set current mouse to last frame mouse, for next frame
        ...
        cam.orthographicSize = Mathf.Lerp(cam.orthographicSize, cam.orthographicSize * Mathf.Pow(1.75f, -Input.mouseScrollDelta.y), 0.01f); //Zoom
